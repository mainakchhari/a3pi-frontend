...
declare module '@angular/common/http/src/client' {
  ...
  export interface HttpClient {
    ...
    /**
     * Skips Token Authentication; such requests wont have Authtorization Header
     * @return The new instance.
     */
    skipTokenAuth(): HttpClient;
  ...
  constructor(private httpHandler: HttpHandler,
    ...
    if (!this.interceptors) {
      ...
      this.interceptors = [
        ...
        this.injector.get(TokenAuthInterceptor),
      ];
    }
  }

  skipTokenAuth(): HttpClient {
    return this.removeInterceptor(TokenAuthInterceptor);
  }
